...
export default function ProjectCard({
  ...
  return (
    ...
    >
      {/* Image: consistent height across all cards */}
      ...
      {/* Content grows; features pinned to bottom */}
        ...
        <div className="mt-auto">
          ...
          <ul className="grid grid-cols-2 gap-x-2 gap-y-1">
            {features.map((feature) => (
              ...
              >
                <svg
                  className="h-3 w-3 text-green-500 mr-1.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
      ...
      {/* Optional: Footer for persistent CTAs instead of hover-only */}
      ...
      <CardFooter className="gap-2">
        ...
        <Link href={githubLink} target="_blank" rel="noopener noreferrer">
          <Button size="sm" variant="outline"> <Github className="h-4 w-4 mr-2" /> Code </Button>
        </Link>
      </CardFooter>
