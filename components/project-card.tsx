  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-grow p-6">
        ...
        <p className="text-sm lg:text-base text-slate-600 dark:text-slate-300 mb-6 line-clamp-3">{description}</p>
            ...
            <div className="flex flex-wrap gap-2">
              {technologies.map((tech) => (
                <Badge
                  key={tech}
                  variant="outline"
                  className="text-sm border-purple-200 text-purple-700 dark:border-purple-800 dark:text-purple-400"
                >
                  {tech}
                </Badge>
              ))}
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 gap-x-4 gap-y-2">
              {features.map((feature) => (
                <li key={feature} className="text-sm text-slate-600 dark:text-slate-300 flex items-center">
